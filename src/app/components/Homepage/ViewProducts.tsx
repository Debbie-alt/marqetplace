  ...
  return (
    <div className='bg-[#8FD7ED40] flex flex-col md:flex-row px-5 py-20 md:pt-0 items-center justify-center w-full pb-20 relative'>
        <div className='text  flex flex-col  max-w-md md:justify-between' >
            ...
            <p className='text-lg font-medium   trcaking-tight'>Accurately visualize the fabric, fit and silhouette of your products as fast as you can imagine them.</p>
             <button className='px-8 py-3  w-[200px] rounded-full text-white bg-[#E8912E] hover:bg-[#E8912E]/90 cursor-pointer text-lg'>Learn More</button>
             </div>
